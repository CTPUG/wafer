...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketType.name'
        db.alter_column(u'tickets_tickettype', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'TicketType.name'
        db.alter_column(u'tickets_tickettype', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
