...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'talks_talktype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=1024)),
        ))
        db.send_create_signal(u'talks', ['TalkType'])

        # Adding field 'Talk.talk_type'
        db.add_column(u'talks_talk', 'talk_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['talks.TalkType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TalkType'
        db.delete_table(u'talks_talktype')

        # Deleting field 'Talk.talk_type'
        db.delete_column(u'talks_talk', 'talk_type_id')
