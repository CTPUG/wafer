...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Talk.notes'
        db.add_column(u'talks_talk', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Talk.notes'
        db.delete_column(u'talks_talk', 'notes')
    ...
    models = {
        ...
        u'talks.talk': {
            ...
            'abstract': ('wafer.snippets.markdown_field.MarkdownTextField', [], {'allow_html': 'False'}),
            'abstract_html': ('django.db.models.fields.TextField', [], {}),
