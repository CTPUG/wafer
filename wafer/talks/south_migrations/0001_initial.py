...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'talks_talk', (
            ('talk_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('corresponding_author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contact_talks', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'talks', ['Talk'])

        # Adding M2M table for field authors on 'Talk'
        m2m_table_name = db.shorten_name(u'talks_talk_authors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('talk', models.ForeignKey(orm[u'talks.talk'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['talk_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field authors on 'Talk'
        db.delete_table(db.shorten_name(u'talks_talk_authors'))
